...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Proceed with sign-up (removed Discord ID check)
  ...
  return (
    <Wrapper className="flex min-h-screen items-center justify-center py-12">
      <AnimationContainer animation="fadeUp" delay={0.2} className="w-auto">
        <div className="border-primary/20 bg-primary/10 dark:border-primary/20 dark:bg-secondary/10 relative overflow-hidden rounded-[30px] border backdrop-blur-md">
          <div className="flex items-center justify-center px-6 py-8">
            <form onSubmit={handleSubmit} className="w-full max-w-xs space-y-4">
              <div className="space-y-2 text-left">
                <h2 className="text-foreground text-2xl font-bold">Create an Account</h2>
                <p className="text-primary text-sm">Enter your info to create your Account.</p>
              </div>
              ...
              <div>
                <Input
                  ...
                  className="border-primary/20 bg-primary/10 text-primary focus:ring-primary dark:border-primary/20 dark:bg-primary/10 w-full rounded-lg border px-3 py-1.5 backdrop-blur-sm focus:ring-2"
                />
                <p className="text-primary mt-1 text-xs">Minimum 8 characters required.</p>
              </div>
