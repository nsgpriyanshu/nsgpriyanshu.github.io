        ...
        {[...Array(5)].map((_, index) => (
          <AnimationContainer key={index} animation="fadeUp" delay={0.15 + index * 0.05}>
            <div className="space-y-3">
              <Skeleton className="shimmer h-3 w-24" aria-hidden />
              <Skeleton className="shimmer h-6 w-3/4" aria-hidden />
            ...
            {index < 4 && <Skeleton className="shimmer my-4 h-px w-full" aria-hidden />}
          </AnimationContainer>
        ))}
      </div>
    </div>
