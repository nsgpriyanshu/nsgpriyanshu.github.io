...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div className="w-full" ref={containerRef}>
      <div className="mx-auto max-w-7xl px-4 py-20 md:px-0">
        ...
        <p className="w-full text-justify text-base font-normal leading-7">
          My journey as a software developer has been an amazing experience, with different phases
          shaping my path.
        </p>
      </div>
      ...
      <div ref={ref} className="relative mx-auto max-w-7xl pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] rounded-full bg-gradient-to-t from-[#f60401] from-[0%] via-[#cbb98f] via-[10%] to-transparent"
          />
        </div>
      </div>
    </div>
