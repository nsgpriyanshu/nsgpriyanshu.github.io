  ...
  return (
    <div className="relative flex flex-col-reverse items-center justify-between w-full py-12 lg:py-16 lg:flex-row">
      <AnimationContainer customClassName="flex flex-col items-center justify-between max-w-lg lg:items-start p-0 lg:pr-8">
        <h3 className="text-sm lg:text-xl text-neutral-300 flex flex-row gap-2">
          Salutations, Code Crafter{" "}
          <span className="text-white"><RocketIcon className='h-5 w-5' /></span>
        </h3>
        <HyperText
          className="py-2 text-xl font-bold text-white lg:py-4 sm:text-3xl lg:text-5xl"
          text="Priyanshu"
        />
        <h3 className="text-base text-center lg:text-start lg:text-lg text-neutral-300">
          <span className="font-medium text-white">
            Writing code and building design{" "}
          </span>
          to build beautiful and functional web applications.
        </h3>
        <h3 className="text-sm lg:text-xl text-neutral-300 flex flex-row gap-2 mt-2">
          <Crosshair2Icon/>{" "}
