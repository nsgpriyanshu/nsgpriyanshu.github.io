  ...
  return (
    <AnimationContainer customClassName="w-full py-12 lg:py-16">
      ...
      <p className="w-full text-justify text-base font-normal leading-7">
        I am Priyanshu, also known as nsgpriyanshu. I am currently pursuing a Bachelor of Technology
        in Computer Science and Engineering. Alongside my studies, my passion for web development
        and AI continues to grow, and I strive to practice and learn every day.
      </p>
    </AnimationContainer>
  )
}
